...
public class HeapPage {
    ...
    public HeapPage(int id, byte[] data, int tableId) throws IOException {
        ...
        System.out.println("this is tableId should b same: " + tableId);
    ...
    public boolean slotOccupied(int s) {
    	//your code here
		 int byteOffset = s / 8;
	        int bitOffset = s % 8;
	        byte headerByte = header[byteOffset];
	        boolean result = ((headerByte >> bitOffset) & 1) == 1;
	        //System.out.println("this is the index: " + s + " is it occupied?: " + result);
    ...
    public void setSlotOccupied(int s, boolean value) {
        //your code here
    	 int byteOffset = s / 8;
	        ...
	        byte headerByte = header[byteOffset];
	        if (value) {
	            headerByte = (byte) (headerByte | (1 << bitOffset));
	        } else {
	            headerByte = (byte) (headerByte & ~(1 << bitOffset));
	        }
	        header[byteOffset] = headerByte;
		//your code here
    }
    ...
    public void addTuple(Tuple t) throws Exception {
    	if (!t.getDesc().equals(td)) {
	        throw new Exception("Tuple different structure");
	    }
    ...
    public void deleteTuple(Tuple t) throws Exception {
    	...
    	//your code here
		 if (t.getPid() != this.id) {
	            throw new Exception("Tuple on wrong page");
	        }

	        int slotId = t.getId();
	        if (!slotOccupied(slotId)) {
	            throw new Exception("Tuple empty");
	        }
     ...
     */
	private Tuple readNextTuple(DataInputStream dis, int slotId) { //error being thrown from this method!
